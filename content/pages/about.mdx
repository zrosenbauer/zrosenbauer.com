...
I'm currently the CTO of [Joggr](https://joggr.ai), **the developer toolkit for building with AI agents**. We give engineering teams the primitives to ship AI-agent features that actually work — context, evals, and the glue between your codebase and the model.
