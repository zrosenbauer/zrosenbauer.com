import { IconBrandDocker, IconBrandGithub, IconBuildingCarousel, IconBrandNextjs, IconTools, IconBrandReact, IconBrandX, IconExclamationCircle } from '@tabler/icons-react';

const tablerIcons = ['brand-x', 'brand-docker', 'brand-github', 'brand-nextjs', 'brand-react', 'tools', 'exclamation-circle', 'building-carousel'] as const;
